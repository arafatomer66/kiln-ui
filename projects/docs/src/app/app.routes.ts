    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'sparkline',  loadComponent: () => import('./pages/components/sparkline.page').then((m) => m.SparklinePage) },
          { path: 'stat-card',  loadComponent: () => import('./pages/components/stat-card.page').then((m) => m.StatCardPage) },
          { path: 'slider',     loadComponent: () => import('./pages/components/slider.page').then((m) => m.SliderPage) },
          { path: 'tag-input',  loadComponent: () => import('./pages/components/tag-input.page').then((m) => m.TagInputPage) },
          { path: 'tree',       loadComponent: () => import('./pages/components/tree.page').then((m) => m.TreePage) },
          { path: 'calendar',   loadComponent: () => import('./pages/components/calendar.page').then((m) => m.CalendarPage) },
          { path: 'avatar-group',         loadComponent: () => import('./pages/components/avatar-group.page').then((m) => m.AvatarGroupPage) },
          { path: 'breadcrumbs',          loadComponent: () => import('./pages/components/breadcrumbs.page').then((m) => m.BreadcrumbsPage) },
          { path: 'rating',               loadComponent: () => import('./pages/components/rating.page').then((m) => m.RatingPage) },
          { path: 'color-picker',         loadComponent: () => import('./pages/components/color-picker.page').then((m) => m.ColorPickerPage) },
          { path: 'number-format-input',  loadComponent: () => import('./pages/components/number-format-input.page').then((m) => m.NumberFormatInputPage) },
          { path: 'page-state',           loadComponent: () => import('./pages/components/page-state.page').then((m) => m.PageStatePage) },
          { path: 'loading-bar',          loadComponent: () => import('./pages/components/loading-bar.page').then((m) => m.LoadingBarPage) },
          { path: 'time-picker',          loadComponent: () => import('./pages/components/time-picker.page').then((m) => m.TimePickerPage) },
          { path: 'confirm',              loadComponent: () => import('./pages/components/confirm.page').then((m) => m.ConfirmPage) },
          { path: 'form-field',           loadComponent: () => import('./pages/components/form-field.page').then((m) => m.FormFieldPage) },
          { path: 'bottom-sheet',         loadComponent: () => import('./pages/components/bottom-sheet.page').then((m) => m.BottomSheetPage) },
          { path: 'action-sheet',         loadComponent: () => import('./pages/components/action-sheet.page').then((m) => m.ActionSheetPage) },
          { path: 'pull-to-refresh',      loadComponent: () => import('./pages/components/pull-to-refresh.page').then((m) => m.PullToRefreshPage) },
          { path: 'tour',                 loadComponent: () => import('./pages/components/tour.page').then((m) => m.TourPage) },
          { path: 'virtual-table',        loadComponent: () => import('./pages/components/virtual-table.page').then((m) => m.VirtualTablePage) },
        ],
      },
    ],
  },
